...
import 'package:speakup_bridge/views/screens/screen_chapter_01_lesson_01_screen_03.dart';
...
class ScreenChapter01 extends StatelessWidget {
  const ScreenChapter01({Key? key}) : super(key: key);
        ...
        child: Column(
            children: [
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text("1/12", style: TextStyle(color: appPrimaryColor)),
                          Row(
                            children: [
                              Image.asset(
              ...
              SizedBox(
                ...
                Get.to(ScreenChapter01Lesson01Screen03());
