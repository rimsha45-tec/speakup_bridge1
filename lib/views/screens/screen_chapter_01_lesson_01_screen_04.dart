...
import 'package:speakup_bridge/views/screens/screen_chapter_01_lesson_01_screen_05.dart';
...
class ScreenChapter01Lesson01Screen04 extends StatelessWidget {
  const ScreenChapter01Lesson01Screen04({Key? key}) : super(key: key);
        ...
        child: Column(
            children: [
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text("3/12", style: TextStyle(color: appPrimaryColor)),
                          Row(
                            children: [
                              Image.asset(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text("something very good and difficult "),
                              Text("that you have succeeded in doing"),
                            ],
                          ),
              ...
              MyCustomButton(text: "Continue",loading: false,onTap: (){
               Get.to(ScreenChapter01Lesson01Screen05());
